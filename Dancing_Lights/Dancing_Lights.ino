...
Adafruit_NeoPixel leds = Adafruit_NeoPixel(5, 6, NEO_GRB + NEO_KHZ800);
...
void loop()
{
  ...
  if(value > 16)
  {
    leds.setPixelColor(4, 255, 0, 0); // Set the first pixel to RED
    leds.setPixelColor(3, 255, 127, 0); // Set the first pixel to RED
    leds.setPixelColor(2, 0, 127, 127); // Set the first pixel to RED
    leds.setPixelColor(1, 0, 255, 127); // Set the first pixel to RED
